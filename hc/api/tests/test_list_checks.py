...
class ListChecksTestCase(BaseTestCase):
    ...
    def test_it_works(self):
        ...
        self.assertEqual(checks['Alice 2']['status'], 'early')
        ...
        self.assertEqual(
            ...
            settings.SITE_ROOT + reverse("hc-api-pause",
            args=[self.a1.code])
        )

    def test_it_shows_only_users_checks(self):
        """Test it shows only user's checks"""
    ...
    def test_accepts_api_key(self):
        ...
        r = self.client.get(
            "/api/v1/checks/", HTTP_X_API_KEY="abc",
